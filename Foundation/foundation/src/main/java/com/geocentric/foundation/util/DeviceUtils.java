...
public class DeviceUtils {
    ...
    public static boolean checkNetWorkAvailable() {
        ConnectivityManager mConenctivity = (ConnectivityManager) BaseApp.getInstance()
    ...
    public static int checkNetWorkStatus() {
        ConnectivityManager mConenctivity = (ConnectivityManager) BaseApp.getInstance().getSystemService(
    ...
    public static String getImagePath(Context context){
        String imageDirString = FileUtils.getStorageDirectory() + File.separator + "images";
    ...
    public static boolean isCardExist() {
        ...
        if (status.equals(Environment.MEDIA_MOUNTED)) {
            ...
            //SD卡已经已经移除
            LogUtils.defaultLog("SD卡已经移除或不存在");
            return false;

        } else if (status.equals(Environment.MEDIA_SHARED)) {
            //SD卡正在使用中
            LogUtils.defaultLog("SD卡正在使用中");
            return false;

        } else if (status.equals(Environment.MEDIA_MOUNTED_READ_ONLY)) {
            //SD卡只能读，不能写
            LogUtils.defaultLog("SD卡只能读，不能写");
            return false;
    ...
    public static String getChannelName() {
        String channel = "";
        try {
            ApplicationInfo appInfo = BaseApp.getInstance().getPackageManager().getApplicationInfo(BaseApp.getInstance().getPackageName(), PackageManager.GET_META_DATA);
