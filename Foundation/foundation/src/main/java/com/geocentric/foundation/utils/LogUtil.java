        ...
        if (DEBUG) {
            ...
            switch (level) {
                case Log.ASSERT:
                    break;
                case Log.DEBUG:
                    Log.d(tag, com.geocentric.foundation.utils.TimeUtil.getTimeFormatMicrosecond(time) + " : ", throwable);
                    break;
                case Log.ERROR:
                    Log.e(tag, com.geocentric.foundation.utils.TimeUtil.getTimeFormatMicrosecond(time) + " : ", throwable);
                    break;
                case Log.INFO:
                    Log.i(tag, com.geocentric.foundation.utils.TimeUtil.getTimeFormatMicrosecond(time) + " : ", throwable);
                    break;
                case Log.VERBOSE:
                    Log.v(tag, com.geocentric.foundation.utils.TimeUtil.getTimeFormatMicrosecond(time) + " : ", throwable);
                    break;
                case Log.WARN:
                    Log.w(tag, com.geocentric.foundation.utils.TimeUtil.getTimeFormatMicrosecond(time) + " : ", throwable);
                    break;
            }
        }
