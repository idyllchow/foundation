package com.sponia.foundation.view;
...
import com.sponia.foundation.utils.DrawableUtil;
...
/**
 * @author shibo
 * @packageName com.sponia.foundation.view
...
//			tWidth = Common.getScreenWidth();
    ...
    private static synchronized void setViewInit(Context ctx, String msg, int gravity,
        ...
        SponiaToast sponiaToast = new SponiaToast(toast, time);
        toastQueue.offer(sponiaToast);
    ...
    private static synchronized void startCountDownTimer() {
        // 取队列第一个toast;
        SponiaToast sponiaToast = toastQueue.peek();
        final Toast tempToast = sponiaToast.getToast();

        int time = sponiaToast.time;
