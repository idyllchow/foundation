...
import com.sponia.foundation.common.PreventContinuousClick;
import com.sponia.foundation.net.IHttpListener;
import com.sponia.foundation.net.NetMessage;
import com.sponia.foundation.utils.LogUtil;
import com.sponia.foundation.utils.SponiaToastUtil;
import com.sponia.foundation.view.sweetalert.SweetAlertDialog;
...
public class BaseActivity extends FragmentActivity implements IHttpListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.sponia.foundation.R.layout.activity_base);
        initUI();
     ...
     */
    private void initUI() {
        actionBar = findViewById(com.sponia.foundation.R.id.actionbar);
        flyTitleLeft = (FrameLayout) findViewById(com.sponia.foundation.R.id.fly_title_left);
        imgTitleLeft = (ImageView) findViewById(com.sponia.foundation.R.id.img_title_left);
        tvLeft = (TextView) findViewById(com.sponia.foundation.R.id.tv_left);
        flyTitleMiddle = (FrameLayout) findViewById(com.sponia.foundation.R.id.fly_title_middle);
        tvRight1 = (TextView) findViewById(com.sponia.foundation.R.id.tv_right1);
        tvRight2 = (TextView) findViewById(com.sponia.foundation.R.id.tv_right2);
        tvRight3 = (TextView) findViewById(com.sponia.foundation.R.id.tv_right3);
        imgRight1 = (ImageView) findViewById(com.sponia.foundation.R.id.img_right1);
        imgRight2 = (ImageView) findViewById(com.sponia.foundation.R.id.img_right2);
        imgRight3 = (ImageView) findViewById(com.sponia.foundation.R.id.img_right3);
        tvTitle = (TextView) findViewById(com.sponia.foundation.R.id.tv_title);
        layoutMid = (FrameLayout) findViewById(com.sponia.foundation.R.id.base_content);
        flyTitleRight1 = findViewById(com.sponia.foundation.R.id.fly_title_right1);
        flyTitleRight2 = findViewById(com.sponia.foundation.R.id.fly_title_right2);
        flyTitleRight3 = findViewById(com.sponia.foundation.R.id.fly_title_right3);
    ...
    public void setActionBarTitle2Left() {
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT, RelativeLayout.LayoutParams.MATCH_PARENT);
        layoutParams.addRule(RelativeLayout.RIGHT_OF, com.sponia.foundation.R.id.fly_title_left);
    }
...
//        flyTitleRight1.setVisibility(View.VISIBLE);
    ...
    public void onClick(View v) {
        if (v.getId() == com.sponia.foundation.R.id.fly_title_left) {
            onBackPressed();
        }
    }
    ...
    public void onHttpError(NetMessage netMsg, final int errorCode, boolean hideErrorMsg) {
        ...
        switch (errorCode) {
            ...
            case IHttpListener.ERROR_VERIFY_EXCEPTION:
                errorStr = getString(com.sponia.foundation.R.string.error_verify_exception);
//                StatsAppConfig.setToken("");
//                CommUtils.cleanToken();
                break;
            case IHttpListener.ERROR_JSON_PARSE_EXCEPTION:
                errorStr = getString(com.sponia.foundation.R.string.error_json_parse_exception);
                break;
            case IHttpListener.ERROR_REQUEST_VERIFY_EXCEPTION:
                errorStr = getString(com.sponia.foundation.R.string.error_request_verify_exception);
                break;
            case IHttpListener.ERROR_PERMISSION_EXCEPTION:
                errorStr = getString(com.sponia.foundation.R.string.error_permission_exception);
                break;
            case IHttpListener.ERROR_TOKEN_EXCEPTION:
                errorStr = getString(com.sponia.foundation.R.string.error_token_exception);
                break;
            case IHttpListener.ERROR_NO_ACCOUNT_EXCEPTION:
                errorStr = getString(com.sponia.foundation.R.string.error_no_account_exception);
                break;
            case IHttpListener.ERROR_PHONE_PWD_EXCEPTION:
                errorStr = getString(com.sponia.foundation.R.string.error_phone_pwd_exception);
                break;
            case IHttpListener.ERROR_PHONE_USED_EXCEPTION:
                errorStr = getString(com.sponia.foundation.R.string.error_phone_used_exception);
                break;
            case IHttpListener.ERROR_VERIFY_CODE_EXCEPTION:
                errorStr = getString(com.sponia.foundation.R.string.error_verify_code_exception);
                break;
            case IHttpListener.ERROR_INVITATION_CODE_EXCEPTION:
                errorStr = getString(com.sponia.foundation.R.string.error_invitation_code_exception);
                break;
            case IHttpListener.ERROR_NO_RESOUCE_EXCEPTION:
                errorStr = getString(com.sponia.foundation.R.string.error_no_resouce_exception);
                break;
            case IHttpListener.ERROR_ACCOUNT_ACTIVATION_EXCEPTION:
                errorStr = getString(com.sponia.foundation.R.string.error_account_activation_exception);
                break;
            case IHttpListener.ERROR_SHIRT_NO_EXCEPTION:
                errorStr = getString(com.sponia.foundation.R.string.error_shirt_no_exception);
                break;
            case IHttpListener.ERROR_EMAIL_USED_EXCEPTION:
                errorStr = getString(com.sponia.foundation.R.string.error_email_used_exception);
                break;
            case IHttpListener.ERROR_NO_UPDATE_EXCEPTION:
                errorStr = getString(com.sponia.foundation.R.string.error_no_update_exception);
                break;
            case IHttpListener.ERROR_NO_JOIN_EXCEPTION:
                errorStr = getString(com.sponia.foundation.R.string.error_no_join_exception);
                break;
            ...
            case IHttpListener.ERROR_SERVER_EXCEPTION:
                errorStr = getString(com.sponia.foundation.R.string.error_server_exception);
                break;
            ...
            case IHttpListener.ERROR_PARAMS_EXCEPTION:
                errorStr = getString(com.sponia.foundation.R.string.error_params_exception);
                break;
            default:
    ...
    public String getErrorNoNetWorkStr() {
        return getResources().getString(com.sponia.foundation.R.string.network_error);
    }

    public String getErrorClientTimeoutStr() {
        return getResources().getString(com.sponia.foundation.R.string.client_timeout);
    }

    public String getErrorcodeStr() {
        return getResources().getString(com.sponia.foundation.R.string.errorCode);
    }

    public String getErrorSSLStr() {
        return getResources().getString(com.sponia.foundation.R.string.sslVerifyFail);
    }

    public String getErrorUnKnown() {
        return getResources().getString(com.sponia.foundation.R.string.unknown);
    }
    ...
    private void exit() {
        if ((System.currentTimeMillis() - exitTime) > EXIT_INTERVAL) {
            SponiaToastUtil.showShortToast("再按一次退出程序");
